...
const {multipleFilesUpload, multipleMulterUpload, singleFilePathUpload} = require('../awsS3');
...
const seedSpots = async function(){const titles = [  "Downtown Parking Available",  "Reserved Parking Spot for Rent",  "24/7 Parking Spot near Stadium",  "Covered Parking Spot for Rent",  "Parking Available in Gated Community",  "Monthly Parking Pass Available",  "Safe and Secure Parking Spot",  "Private Parking Spot for Rent",  "Convenient Parking Spot near Transit",  "Parking Spot for Commuters",  "RV Parking Spot for Rent",  "Outdoor Parking Spot Available",  "Parking Spot with EV Charging",  "Short-term Parking Available",  "Long-term Parking Available",  "Parking for Motorcycles Available",  "Parking Spot in Busy Neighborhood",  "Parking for Events Available",  "Off-Street Parking Available",  "Tandem Parking Spot for Rent"]
...
const filePath = "/Users/josephbergmann/Downloads/4.webp"
